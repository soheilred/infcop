...
def making_plots_perf(arch, dataset, exper_cntr, exper_no_cntr):
    ...
    cntr_dir = f"../output/performance/{arch}/{dataset}/cntr/8/" + exper_cntr
...
def main():
    ...
    exper_cntr = ["", "13-32/", "13-38/", "13-56/"]
    exper_no_cntr = [""]

    # exper_cntr = ""
    # exper_no_cntr = ""

    making_plots_perf(ARCHS[0], DATASETS[1], exper_cntr[-1], exper_no_cntr[-1])
